import { Battery, Maximize2, Minus, Volume2, Wifi, X } from "lucide-react";
...
const MenuBar = ({
  ...
  return (
    <div
      className="h-8 bg-slate-950/80 backdrop-blur-md border-b border-slate-800/50 flex items-center justify-between px-4 text-white text-sm relative z-50"
      ref={menuRef}
    >
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-1">
          ...
          <span className="text-slate-300 text-xs">{batteryLevel}%</span>
        </div>
